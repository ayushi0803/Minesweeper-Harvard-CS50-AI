...
class MinesweeperAI():
    ...
    def update_knowledge(self):
        """
        Updates knowledge base, marking cells as safe or mines if possible,
        and adding any new sentences inferred from existing knowledge.
        """
        changes = True
        while changes:
            changes = False

            # Create copies of knowledge sets
            safes = set()
            mines = set()
            ...
            # If new cells are identified, update knowledge base
            for cell in safes:
